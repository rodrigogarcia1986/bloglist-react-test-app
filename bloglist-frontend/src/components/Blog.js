    ...
    <>
      <div className='blog'>
        <div className="blogTitle">
          <p>{blog.title} <button style={hideWhenVisible} type="button" onClick={() => {
            setVisible(true)
            console.log(isVisible)
          }}>view</button> | <button type="button" onClick={() => handleDeleteBlog(blog)}>delete</button></p>
        </div>
        <div style={showWhenVisible} className="blogDetail">
          <p>{blog.author}</p>
          <p>{blog.url}</p>
          <p>{blog.likes} <button type="button" onClick={() => {
          ...
          <button style={showWhenVisible} type="button" onClick={() => {
            setVisible(false)
            console.log(isVisible)
          }}>hide</button>
        </div>
